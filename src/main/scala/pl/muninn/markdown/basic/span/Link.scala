...
object Link:
  def a(alt: String, link: String)(using md: AnyMarkdownFragment, configuration: Configuration) =
    md += Link(alt = Text(alt), link = Text(link), title = None)

  def a(alt: String, link: String, title: String)(using md: AnyMarkdownFragment, configuration: Configuration) =
